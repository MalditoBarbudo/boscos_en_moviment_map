...
# miquel martinez foto
data_map[42, 'recurso'] <- 'imagen'
data_map[42, 'arxivo'] <- 'f1.jpg'
...
data_map_foto <- data_map %>%
  ...
  dplyr::mutate(arxivo = stringr::str_replace(arxivo, '.JPG', '.jpg'),
                ...
                link_2 = c(
                  ...
                  'https://lh3.googleusercontent.com/r1Ytl81XieVF3BusPdUNjrzu4F1S_7K4S09FHXvVFIqQKHcw0Wlawg5lr3i_HDaGoMNZSX6CVW77dxCTsJxM6UumwS1TL7jWzhn03a4LGQoRaubfFFzeClFnO6GOnQGYLteKrJz_VasSuH8XTUDC-L4xEnBw4BwPdopEKbA14SQAYztSwecVlGrrzhG3AT5LNqE98aBhSi_4l33i-RO1-D4cvGLrAQEmgeJmJNGKZkA9Z5qlZTMgyUI3RLqRzcj0li1J5c32j2wd_600Bn61lHsbVPRGirZsygFOZ1JpbDeJrwXL3MxT1Hn0EDabzuf4tY_t7iIq0hwkEd1pdVZ7jE38RmLJhPNBFGW4S3D22U_8nfmgWaeQIFJ39wtnxsLBCXnHo70e2FP4RqASiEC7ePMEckSE-p5IPxk0bzCHKqt8DgUD2CUXZyIxUBDlID8etQ10jHiSxJkWPCpeIa_lAKNTjULF2lzd9FRFl7tz_NEmIo44TeO9G7bTUC17nSEviqioGO0MwwyqOyP62DOtURHztlq8NO9F4X5rOdxAWmglXzsQ13twO1IbeAFsAUuHznXzWf8xOPyOxbVZVlq549Vlhg5moXIGCnffN9119Qlw21lxVB_Y_wP5tRrpIbnOd2QHAY8aLANC4eyFHTraFJBY-mZHzYUD=w800-h412-no',
                ...
                link_4 = {
                  link_3 %>%
                    str_sub(end = -25) %>%
                    paste0('<p class="textphoto"> ', Texto_OK, ' </p> </table> </body> </html>')
                }) %>%
  dplyr::slice(-2)
...
global_map <- data_map_video %>%
  ...
  addLegend(
    ...
    pal = colorFactor(palette = c('#00E640', '#947CB0', '#F03434'),
                      domain = c('vídeo', 'text', 'imatge')),
    values = c('vídeo', 'text', 'imatge'),
    opacity = 1
  )
